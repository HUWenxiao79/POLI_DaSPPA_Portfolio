...
-   `semi_join`: Filter out observations that does **not appea**r in the right-hand-side table

    #to check if an identify of the data point is shown on the right-hand-side table ---does: show the record//doesn't: shrow away
...
#left: d_gdp_2000_2022  right:d_gdppc_1984_2010
